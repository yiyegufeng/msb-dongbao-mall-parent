...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("D:\\IDEA_workspace\\msb-dongbao-mall-parent\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
		gc.setAuthor("卢文铯");
		...
		dsc.setUrl("jdbc:mysql://192.168.31.210:3306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
